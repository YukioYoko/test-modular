...
export default function MenuPruebaPage() {
  return (
    <div className="min-h-screen bg-(--notWhite) flex items-center justify-center p-6">
      {/* Suspense es obligatorio cuando el Header o cualquier componente usa useSearchParams */}
      <Suspense fallback={<div className="animate-pulse text-(--militar-green) font-black">Cargando modo prueba...</div>}>
        <MenuPruebaContent />
      </Suspense>
    </div>
  );
