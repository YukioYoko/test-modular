"""
main.py — API de Recomendación Contextual para Foodlify
========================================================
Endpoint principal: GET /recomendar-menu

Devuelve recomendaciones de platillos basadas en el contexto actual
(hora, clima, día, festivo) usando distribuciones de probabilidad
aprendidas de órdenes reales con K-Means.
"""
